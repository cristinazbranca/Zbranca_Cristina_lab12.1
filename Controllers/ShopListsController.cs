...
namespace Zbranca_Cristina_lab12._1.Controllers
{
    [Route("api/[controller]")]
    [ApiController]
    public class ShopListsController : ControllerBase
    {
        private readonly Zbranca_Cristina_lab12_1Context _context;

        public ShopListsController(Zbranca_Cristina_lab12_1Context context)
        {
            _context = context;
        }
